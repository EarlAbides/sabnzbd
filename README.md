...
Check the [releases](https://github.com/droboports/sabnzbd/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/sabnzbd.git
cd sabnzbd
./build.sh
ls -la *.tgz
```
